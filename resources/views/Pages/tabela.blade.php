...
<link href="https://cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css"> 
    ...
    <body class="antialiased">
        ...
        <div class="container">
   <div class="titulo">Busca de Empresas:</div>


   <div class="titulo-resultado titulo  b-flex">Resultados para:</div>
   <a class="nav-link link box-link b-flex" href="{{ ('registerBusiness') }}">{{ __('Add Empresa') }}</a>
        @php $index=1 @endphp
        @foreach ($retorno as $busca)  
            <div class="box-link">
            <a class="mb-3  box-link"  href="{{ ('registerBusiness') }}" >
                <div class="titulo_card">{{$index}}. {{$busca->titulo }}</div>               
    ...
    var data=[];
      @foreach($retorno as $busca)
             data.push([                
                ...
                '{{$busca->estado}}',
                '{{$busca->descricao}}',
                '<a class="mb-3"  href="{{ ("registerBusiness") }}" >teste</a>',
                  ]
             );
